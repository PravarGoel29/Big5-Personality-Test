...
#Testing the GEDCOM file to see if the parents got married after the age of 18
import datetime


def birth_date_less_marriage_date():
	print("Sprint1 user story")
	results = get_family()
	for res in results:
		if "marriage" in res and res["marriage"] is not None:
			...
			if "HUSBAND" in res and "WIFE" in res:
				...
				if wife_age < 18 or husband_age < 18:
					...
					save_invalid_family_for_print(res["FAMID"], "Sprint1 user story", message)